...
export function SectionHero() {
    return (
        <div className="bg-img-bg-hero h-[88vh] w-[100vw] bg-no-repeat bg-cover flex mx-auto">
            <div className="mx-auto flex w-[80vw] flex-col text-center sm:flex-row sm:text-left pt-8 justify-between">
                <div>
