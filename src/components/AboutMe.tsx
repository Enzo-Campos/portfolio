  ...
  return (
    ...
    lg:max-w-[80vw] lg:m-auto lg:my-[30px]' id='sobre'>
        ...
        <p className='text-[0.8rem] font-thin xl:text-[0.9rem]'>
          ...
          abr de 2022 - o momento · 1 ano 8 meses<br></br><br></br>
